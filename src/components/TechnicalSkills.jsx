          ...
          >
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {resumeData.skills[group.key].map((skill) => (
                <span
                  key={skill}
                  className="rounded-full border border-ink-900/10 bg-cream-100/70 px-3 py-1 text-xs font-medium text-ink-700 dark:border-cream-100/10 dark:bg-ink-900/50 dark:text-cream-100/80"
                >
                  {skill}
                </span>
              ))}
