...
import { Award, Briefcase, Cpu, GraduationCap, Home } from 'lucide-react'
...
const links = [
  { label: 'Home', href: '#home', icon: Home, onClick: scrollToTop },
...
function DockIcon({ mouseX, label, href, icon: Icon, onClick }) {
